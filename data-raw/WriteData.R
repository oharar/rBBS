...
SpFiles <- rbind(do.call(rbind, Tables.1), do.call(rbind, Tables.2), do.call(rbind, Tables.3), do.call(rbind, Tables.4))

SpNames <- GetSpNames()
SpCodes <- merge(SpNames, SpFiles[,c("AOU", "FileString")], all=TRUE, by="AOU")
